...
namespace Kmplete
{
    ...
    namespace Graphics
    {
        void InitializePushConstantsGraphicsParameters(GraphicsParameters& parameters)
        {
        ...
        try
        {
            WindowApplicationParameters parameters = WindowApplicationParameters{
                .applicationParameters = {
                    .applicationName = "Push constants sandbox",
                    .settingsFilepath = programOptions.GetSettingsFilepath(),
                    .defaultSettingsFileName = "PushConstantsSandbox_settings.json"
                },
                .resizable = true
            };

            Graphics::ClientInitializeGraphicsParametersFn = Graphics::InitializePushConstantsGraphicsParameters;

            return CreateUPtr<PushConstantsApplication>(parameters);
        }

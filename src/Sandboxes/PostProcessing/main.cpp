...
namespace Kmplete
{
    ...
    namespace Graphics
    {
        void InitializePostProcessingGraphicsParameters(GraphicsParameters& parameters)
        {
        ...
        try
        {
            WindowApplicationParameters parameters = WindowApplicationParameters{
                .applicationParameters = {
                    .applicationName = "Post processing sandbox",
                    .settingsFilepath = programOptions.GetSettingsFilepath(),
                    .defaultSettingsFileName = "PostProcessingSandbox_settings.json"
                },
                .resizable = true
            };

            Graphics::ClientInitializeGraphicsParametersFn = Graphics::InitializePostProcessingGraphicsParameters;

            return CreateUPtr<PostProcessingApplication>(parameters);
        }

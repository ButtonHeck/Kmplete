...
namespace Kmplete
{
    constexpr static auto WorkingModeUpdate = "Update";
    constexpr static auto WorkingModeCompile = "Compile";
    //--------------------------------------------------------------------------
    ...
    {
    public:
        explicit Translator(TranslatorParameters&& parameters) noexcept;

        ...
        namespace VulkanUtils
        {
            String VkResultToString(VkResult result) noexcept
            {
                ...
                case VK_PIPELINE_BINARY_MISSING_KHR:
                    return "VK_PIPELINE_BINARY_MISSING_KHR - The application attempted to create a pipeline binary by querying an internal cache, but the internal cache entry did not exist";
                ...
                case VK_ERROR_VALIDATION_FAILED_EXT:
                    return "VK_ERROR_VALIDATION_FAILED_EXT - A command failed because invalid usage was detected by the implementation or a validation layer. This may result in the command not being dispatched to the ICD";
                ...
                case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
                    return "VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT - An operation on a swapchain created with VK_FULL_SCREEN_EXCLUSIVE_APPLICATION_CONTROLLED_EXT failed as it did not have exclusive full-screen access";
                case VK_ERROR_COMPRESSION_EXHAUSTED_EXT:
                    return "VK_ERROR_COMPRESSION_EXHAUSTED_EXT - An image creation failed because internal resources required for compression are exhausted. This must only be returned when fixed-rate compression is requested";
                case VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR:
                    return "VK_ERROR_IMAGE_USAGE_NOT_SUPPORTED_KHR - The requested VkImageUsageFlags are not supported";
                ...
                case VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR:
                    return "VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR - A video profile operation specified via VkVideoProfileInfoKHR::videoCodecOperation is not supported";
                case VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR:
                    return "VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR - Format parameters in a requested VkVideoProfileInfoKHR chain are not supported";
                case VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR:
                    return "VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR - Codec-specific parameters in a requested VkVideoProfileInfoKHR chain are not supported";
                case VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR:
                    return "VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR - The specified video Std header version is not supported";
                ...
                case VK_ERROR_NOT_PERMITTED:
                    return "VK_ERROR_NOT_PERMITTED - The driver implementation has denied a request to acquire a priority above the default priority (VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT) because the application does not have sufficient privileges";
                case VK_ERROR_NOT_ENOUGH_SPACE_KHR:
                    return "VK_ERROR_NOT_ENOUGH_SPACE_KHR - The application did not provide enough space to return all the required data";
                default:
                    break;
                }

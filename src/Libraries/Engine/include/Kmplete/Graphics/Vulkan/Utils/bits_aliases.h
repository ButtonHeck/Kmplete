...
namespace Kmplete
{
    namespace Graphics
    {
        namespace VKBits
        {
            ...
            static constexpr auto VK_FormatFeature_SampledImage = VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT;
            static constexpr auto VK_FormatFeature_StorageImage = VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT;
            static constexpr auto VK_FormatFeature_StorageImageAtomic = VK_FORMAT_FEATURE_STORAGE_IMAGE_ATOMIC_BIT;
            static constexpr auto VK_FormatFeature_UniformTexelBuffer = VK_FORMAT_FEATURE_UNIFORM_TEXEL_BUFFER_BIT;
            static constexpr auto VK_FormatFeature_StorageTexelBuffer = VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_BIT;
            static constexpr auto VK_FormatFeature_StorageTexelBufferAtomic = VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_ATOMIC_BIT;
            static constexpr auto VK_FormatFeature_VertexBuffer = VK_FORMAT_FEATURE_VERTEX_BUFFER_BIT;
            static constexpr auto VK_FormatFeature_ColorAttachment = VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT;
            static constexpr auto VK_FormatFeature_ColorAttachmentBlend = VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT;
            static constexpr auto VK_FormatFeature_DepthStencilAttachment = VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT;
            static constexpr auto VK_FormatFeature_BlitSrc = VK_FORMAT_FEATURE_BLIT_SRC_BIT;
            static constexpr auto VK_FormatFeature_BlitDst = VK_FORMAT_FEATURE_BLIT_DST_BIT;
            static constexpr auto VK_FormatFeature_SampledImageFilterLinear = VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT;
            static constexpr auto VK_FormatFeature_TransferSrc = VK_FORMAT_FEATURE_TRANSFER_SRC_BIT;
            static constexpr auto VK_FormatFeature_TransferDst = VK_FORMAT_FEATURE_TRANSFER_DST_BIT;
            static constexpr auto VK_FormatFeature_MidpointChromaSamples = VK_FORMAT_FEATURE_MIDPOINT_CHROMA_SAMPLES_BIT;
            static constexpr auto VK_FormatFeature_SampledImageYCbCrConversionLinearFilter = VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT;
            static constexpr auto VK_FormatFeature_SampledImageYCbCrConversionSeparateReconstructionFilter = VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT;
            static constexpr auto VK_FormatFeature_SampledImageYCbCrConversionChromaReconstructionExplicit = VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT;
            static constexpr auto VK_FormatFeature_SampledImageYCbCrConversionChromaReconstructionExplicitForceable = VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT;
            static constexpr auto VK_FormatFeature_Disjoint = VK_FORMAT_FEATURE_DISJOINT_BIT;
            static constexpr auto VK_FormatFeature_CositedChromaSamples = VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT;
            static constexpr auto VK_FormatFeature_SampledImageFilterMinMax = VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT;
            static constexpr auto VK_FormatFeature_VideoDecodeOutput = VK_FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR;
            static constexpr auto VK_FormatFeature_VideoDecodeDPB = VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR;
            static constexpr auto VK_FormatFeature_AccelerationStructureVertexBuffer = VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR;
            static constexpr auto VK_FormatFeature_SampledImageFilterCubic = VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT;
            static constexpr auto VK_FormatFeature_FragmentDensityMap = VK_FORMAT_FEATURE_FRAGMENT_DENSITY_MAP_BIT_EXT;
            static constexpr auto VK_FormatFeature_FragmentShadingRateAttachment = VK_FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR;
            static constexpr auto VK_FormatFeature_VideoEncodeInput = VK_FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR;
            static constexpr auto VK_FormatFeature_VideoEncodeDPB = VK_FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR;
